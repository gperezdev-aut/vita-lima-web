...
const FICHAS: Record<string, FichaData> = {
  "stub-nuevo": {
    ...
    requiere: { codigoCupon: false, correoObligatorio: false, documentoParaBoleta: "opcional", confirmacionManual: false },
  ...
  "stub-cupon": {
    ...
    requiere: { codigoCupon: true, correoObligatorio: false, documentoParaBoleta: "no", confirmacionManual: false },
    cliente: { conocido: false, nombre: "" },
    politicaCancelacionUrl: "/politica-de-privacidad",
  ...
  "stub-extranjero": {
    ...
    requiere: { codigoCupon: false, correoObligatorio: true, documentoParaBoleta: "no", confirmacionManual: false },
    cliente: { conocido: false, nombre: "" },
    politicaCancelacionUrl: "/politica-de-privacidad",
  },
  "stub-domicilio": {
    ...
    cita: {
      fecha: "2026-09-17",
      hora: "16:00",
      sede: "Atención a domicilio · Miraflores · Av. Ejemplo 123 · Referencia: portón negro",
      sedeDireccion: "Av. Ejemplo 123, Miraflores",
      sedeMapsUrl: null,
      personas: 1,
    ...
    requiere: { codigoCupon: false, correoObligatorio: false, documentoParaBoleta: "opcional", confirmacionManual: true },
    cliente: { conocido: false, nombre: "" },
    politicaCancelacionUrl: "/politica-de-privacidad",
  },
};
