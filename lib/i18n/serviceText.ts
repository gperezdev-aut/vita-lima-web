...
//
// El nombre sale siempre limpio de emojis: este es el único sitio por el que
// pasan los nombres antes de mostrarse, así que limpiarlo aquí lo arregla de
// una vez en el título de la ficha, las migas, el catálogo, el carrusel del
// home y los textos alternativos de las fotos.
export function serviceText(service: Service, language: Language) {
  ...
  return {
    name: cleanServiceName(service.nameEn || service.name),
