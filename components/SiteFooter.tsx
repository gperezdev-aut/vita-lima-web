  ...
  return (
    <footer className="footer">
      ...
      <div className="shell footerGrid">
        ...
        <div><h4>{t.infoHeading}</h4><Link href={href("/politica-de-privacidad")}>{t.infoLinks.privacidad}</Link><Link href={href("/terminos-y-condiciones")}>{t.infoLinks.terminos}</Link><a href={sectionHref("preguntas")}>{t.infoLinks.faq}</a><Link href={href("/empresas")}>{t.staffLogin}</Link></div>
