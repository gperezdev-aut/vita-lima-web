  ...
  return (
    <footer className="footer">
      ...
      <div className="shell footerGrid">
        ...
        <div><h4>{t.infoHeading}</h4><a href="/politica-de-privacidad">{t.infoLinks.privacidad}</a><a href="/terminos-y-condiciones">{t.infoLinks.terminos}</a><a href={sectionHref("preguntas")}>{t.infoLinks.faq}</a><a href="https://caja.vitalimaspa.com/login" target="_blank" rel="noreferrer">{t.staffLogin}</a></div>
