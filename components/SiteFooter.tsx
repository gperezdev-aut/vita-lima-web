  ...
  return (
    <footer className="footer">
      ...
      <div className="shell footerGrid">
        ...
        <div><h4>{t.exploreHeading}</h4><Link href={href("/servicios")}>{t.exploreLinks.catalog}</Link><Link href="/guias">{t.exploreLinks.guias}</Link><Link href={href("/san-borja")}>{t.exploreLinks.sanBorja}</Link><Link href={href("/miraflores")}>{t.exploreLinks.miraflores}</Link><Link href="/empresas">{t.exploreLinks.empresas}</Link><Link href="/regalos">{t.exploreLinks.giftCards}</Link><a href={sectionHref("reserva")}>{t.exploreLinks.reservar}</a></div>
        ...
        <div><h4>{t.infoHeading}</h4><Link href={href("/politica-de-privacidad")}>{t.infoLinks.privacidad}</Link><Link href={href("/terminos-y-condiciones")}>{t.infoLinks.terminos}</Link><a href={sectionHref("preguntas")}>{t.infoLinks.faq}</a><a href="https://caja.vitalimaspa.com/login" target="_blank" rel="noreferrer">{t.staffLogin}</a></div>
