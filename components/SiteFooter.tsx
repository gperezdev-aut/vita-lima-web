  ...
  return (
    <footer className="footer">
      ...
      <div className="shell footerGrid">
        ...
        <div><h4>{t.infoHeading}</h4><Link href="/politica-de-privacidad">{t.infoLinks.privacidad}</Link><Link href="/terminos-y-condiciones">{t.infoLinks.terminos}</Link><a href={sectionHref("preguntas")}>{t.infoLinks.faq}</a><Link href="/empresas">{t.staffLogin}</Link></div>
